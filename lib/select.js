...
Select.prototype._writeFirst = function () {
    if (this._setAttrsLen) {
        var str = setAttrs(this._first[1], this._setAttrs);
        this.input.write([ this._first[0], str ]);
    }
    else this.input.write(this._first);
};
...
console.log('SET ATTR', key, value);
